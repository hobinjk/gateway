...
class TplightDevice extends Device {
  constructor(adapter, id, bulb) {
    ...
    this.properties.set('saturation', new TplightProperty(this, 'saturation', 'number', saturation));
    this.properties.set('brightness', new TplightProperty(this, 'brightness', 'number', brightness));
    this.properties.set('colorTemp', new TplightProperty(this, 'colorTemp', 'number', colorTemp));
